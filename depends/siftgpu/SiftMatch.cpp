...
int  SiftMatchGL::GetGuidedSiftMatch(int max_match, uint32_t match_buffer[][2], float H[3][3], float F[3][3],
...
int  SiftMatchGPU::GetGuidedSiftMatch(int max_match, uint32_t match_buffer[][2], float H[3][3], float F[3][3], 
